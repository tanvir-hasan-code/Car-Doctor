...
export default function LoginPage() {
	...
	const handleLoginForm = async (e) => {
		...
		const creadintial = { email, password };
  ...
  return (
	<section className='max-w-7xl mx-auto flex flex-col md:flex-row my-10'>
		  ...
		  <div className='flex-1'> 
			  <form onSubmit={handleLoginForm} className='grid gap-6 max-w-md mx-auto border rounded-2xl shadow-xl p-10'>
				  ...
				  <div>
					  <label className='grid gap-2' htmlFor="Password">Password: 
				  ...
				  <p className='text-center'>Don’t have an account? <Link href={"/register"} className='font-bold text-orange-600'> Sign Up</Link></p>
			  </form>
		  </div>
	</section>
  )
