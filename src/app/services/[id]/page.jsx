      ...
      <section className=" max-w-7xl mx-auto my-6">
        <div className="relative">
          ...
          <div className="absolute color-overly top-0 rounded-2xl w-full h-full  ">
            <h1 className="text-white text-xl md:text-3xl lg:text-5xl font-bold flex items-center h-full ml-8 md:ml-12 lg:ml-16">
              ⟴ Service Details
            </h1>
            ...
            <div className="grid md:grid-cols-2 gap-2 mt-5">
              {data?.facility.map((item, i) => {
                return (
                  <div
                    key={i}
                    className="p-8 bg-gray-200 rounded-2xl   border-t-3  border-orange-600"
                  >
          ...
          <div className="md:col-span-4 lg:pl-8">
            ...
            <div className="p-8 rounded-2xl bg-gray-200 mt-5 space-y-2">
              ...
              <Link href={`/checkout/${id}`}>
                <button className="btn btn-dash bg-orange-500 text-white w-full">
                  CheckOut
                </button>
              </Link>
            </div>
